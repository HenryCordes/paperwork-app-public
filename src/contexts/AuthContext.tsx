...
// eslint-disable-next-line react-refresh/only-export-components -- idiomatic Context+Provider+hook-in-one-file pattern; splitting would spread three tightly-coupled pieces across two files for a dev-only HMR optimization
